const quiz6 = [
 ...
 " tôn trọng nhân dân, tận tụy phục vụ nhân dân",
  ...
  {
    question:
      "  12. căn cứ luật CBCC, quyền của cán bộ công chức về tiền lương và các chế dodojj liên quan đến tiền lương được quy định như thế nào?",
    choices: [
      " được nhà nước bảo đảm tiền lương tương xứng với nhiệm vụ quyềm hạn được giao,phù hợp với điều kiện kinh tế xã hội của đất nước",
      " cán bộ công chức làm việc ở miền núi, biên giới, vùng sâu, vùng xa, vùng dân tộc thiểu số, vùng có điều kiện kinh tế - xã hội đặc biệt khó khăn hoặc trong các ngành nghề có môi trường độc hại, nguy hiểm được hưởng phụ cấp và chính sách ưu đãi theo quy định pháp luật",
      " được xem xét trả lương dựa trên vị trí, việc làm",
  ...
  },
  {
    ...
    choices: [
      ...
      " CBCC phải thực hành tiết kiệm, giữ gìn đoàn kết nội bộ và phục tùng mệnh lệnh cấp trên",
  ...
  },
  {
    ...
    choices: [
      " CBCC phải gần gũi với nhân dân, có tác phong, thái độ lịch sự, nghiệm túc khiêm tốn, ngôn ngữ giao tiếp phải chuẩn mực rõ ràng, mạch lạc",
      " CBCC không được hách dịch, cửa quyền, gây khó khăn, phiền hà cho nhân dân khi thi hành công vụ",
      " CBCC phải mang phù hiệu hoặc thẻ công chức",
  ...
  },
  {
    ...
    choices: [
      " CBCC không được tiết lộ thông tin liên quan đến bí mật nhà nước dưới mọi hình thức",
      " CBCC làm việc ở ngành nghề có liên quan đến bí mật nhà nước thì trong thời hạn ít nhất 05 năm kể từ khi có quyết định nghỉ hưu, thôi việc, không được làm các công việc có liên quan đến ngành, nghề mà trước đây mình đã đảm nhiệm cho TC, CN trong nước, TC,CN nước ngoài hoặc liên danh với nước ngoài",
      " sử dụng tài liệu của NHà nước trái pháp luật",
  ...
  },
  {
    ...
    choices: [
      " Hải quan VN được tổ chức hoạt động theo nguyên tắc tập trung, thống nhất",
      " Tổng cục trưởng Tổng cục HQ thống nhất quản lý, điều hành hoạt động của HQ các cấp",
      " Tận tụy với công việc được giao",
      ...
      },
  {
    ...
    choices: [
      " là người làm việc theo chế độ hợp đồng lao động tại các đơn vị trong ngành hải quan",
  ...
  },
  {
    ...
    choices: [
      " ngay sau khi phát hiện vi phạm của công chức",
      " theo đề nghị của người sử dụng công chức",
  ...
  {
    question:
      " 22. các mức xếp loại chất lượng công chức theo luật CBCC sửa đổi bổ sung năm 2019 là gì",
    choices: [
  ...
  {
    question:
      " 24. ai là viên chức hải quan theo luật Viên chức và luật CBCC sửa đổi năm 2019?",
    choices: [
      " Tổng biên tập báo hải quan",
      " hiệu trưởng trường HQ VN",
      " trưởng trung tâm phân tích thuộc cục kiểm định HQ",
      " trưởng ban cải cash hiện đại hóa HQ"
    ],
    correct: 
      " Tổng biên tập báo hải quan",
      " hiệu trưởng trường HQ VN",
  ...
  {
    question:
      " 28. luật CBCC năm 2019 bổ sung quy định xử lý kỷ luật đối với đối tượng nào?",
    choices: [
      " Công chức đã chết",
      " Công chức đã nghỉ việc",
  ...
  },
  {
    ...
    choices: [
      ...
      " bị tòa án kết án phạt tù nhưng cho hưởng án treo",
  ...
  {
    question:
      " 32. theo quy định tại luật HQ, địa bàn hoạt động hải quan gồm những khu vực nào?",
    choices: [
      " khu vực cửa khẩu đường bộ, ga đường sắt liên vận quốc tế, cảng biển, cảng hàng không dân dụng quốc tế, cảng thủy nội địa có hoạt động XK,NK,XC,NC,QC",
      " khu vực đang lưu giữ hàng hóa chịu sự giám sát của hải quan, khu chế xuất, khu vực ưu đãi hải quan",
      " các địa điểm làm thủ tục hải quan, kho ngoại quan, kho bảo thuế, bưu điện quốc tế, trụ sở NKHQ nơi thưc hiện kiểm tra STQ, các địa điểm kiểm tra hàng hóa XK, NK trong lãnh thổ hải quan",
  ...
  },
  {
    ...
    choices: [
      ...
      " tổ chức thực hiện pháp luật về thuế đối với hàng hóa XK,BK, thống kê hàng hóa XK,NK theo quy định pháp luật",
      " giữ gìn trật tự, an ninh biên giới",
    ],
    correct: 
      "  thực hiện kiểm tra, giám sát hàng hóa, PTVT",
      " phòng, chống buôn lậu, vận chuyển trái phép hàng hóa qua biên giới",
  ...
  },
  {
    ...
    choices: [
      " Trường hải quan VN",
      " Đội/Tổ thuộc chi cụ HQ, đội kiểm soát hải quan và tương đương",
  ...
  {
    question:
      " 35. nguyên tắc xử lý kỷ luật được quy định như thế nào tại NĐ 112/2020/nđ-cp về xử lý kỷ luật cán bộ, công chức, viên chức ?",
    choices: [
      " khách quan, công bằng, minh bạch, nghiêm minh, đúng pháp luật",
  ...
  {
    question:
      " 36. trường hợp CBCC viên chức đang trong thời gian thi hành quyết định kỷ luật tiếp tục có hành vi vi phạm thì bị áp dụng hình thức kỷ luật như thế nào?",
    choices: [
      ...
      " nếu có hành vi vi phạm bị xử lý kỷ luaajrt ở hình thức nặng hơn so với hình thức kỷ luật nhẹ hơn một mức so với hình thức kỷ luật áp dụng đối với hành vi vi phạm mới"
    ],
    correct:  
      " Nếu có hành vi vi phạm bị xử lý kỷ luật ở hình thức nhẹ hơn hoặc so với hình thức kỷ luật đang thi hành thì áp dụng hình thức kỷ luật nặng hơn một mức so với hinh thức kỷ luật đang thi hành",
      " nếu có hành vi vi phạm bị xử lý kỷ luật ở hình thức nặng hơn so với hình thức kỷ luật đang thi hành thì áp dụng hình thức kỷ luật nặng hơn một mức so với hình thức kỷ luật áp dụng đối với hành vi vi phạm mới",
  ...
  },
  {
    ...
    choices: [
      " CB,CC, viên chức đang trong thời gian điều trị bệnh hiểm nghèo hoặc đang mất khả năng nhận thức, bị ốm nặng đang điều trị nội trú tại bệnh viên có xác nhận của cơ quan y tế có thẩm quyền",
      " CB, CC, VC đang trong thời gian nghỉ hàng năm, nghỉ theo chế độ, nghỉ việc riêng được cấp có thẩm quyền cho phép",
      " CB,CC, VC là nữ giới đang trong thời gian mang thai, nghỉ thai sản, đang nuôi con dưới 12 tháng tuổi hoặc CB,CC,VC là nam giới ( trong trường hợp vợ chết hoặc lý do khách quan, bất khả kháng khác) đang nuôi con dưới 12 tháng tuổi",
  ...
  },
  {
    ...
    choices: [
      ...
      " là vi phạm có tính chất, mức độ, tác hại rất lớn, phạm vi tác động đến toàn xã hội, gây dư luận rât bức xúc trong CB,CC,VC bag nhân dân, làm mất uy tín của CQ,TC, đơn vị công tác",
  ...
  {
    question:
      " 40. nguyên tắc đánh giá, xếp loại chất lượng CC,CB,VC được quy định thế nào tại NĐ 90/2020/nđ-cp?",
    choices: [
      " đảm bảo khách quan, công bằng chính xác, không thiên vị, hình thức, bảo đảm đúng thẩm quyền quản lý đánh giá CB,CC,VC",
...
" Có trách nhiệm với công việc, năng động, sáng tạo, dám nghĩ, dám làm, linh hoạt trong thực hiện nhiệm vụ",
 ...
 " chấp hành sự phân công của tổ chức",
  ...
  {
    question:
      " 46. tiêu chí nào sau đây không thuộc tiêu chí về kết quả thực hiện chức trách, nhiệm vụ được giao trong đánh giá, xếp loại chất lượng cán bộ, công chức, viên chức lãnh đạo quản lý?",
    choices: [
  ...
  },
  {
    ...
    correct: "  quán triệt, thể chế hóa và thực hiện chủ trương đường lối của Đảng, chính sách pháp luật của Nhà nước tại cơ quan, tổ chức, đơn vị",
      "  lãnh đạo, chỉ đạo, tổ chức kiểm tra, thanh tra, giám sát, giải quyết khiếu nại, tổ cáo theo thẩm quyền, chỉ đạo, thực hiện công tác cải cách hành chính, cải cách chế độ công vụ, công chức tạo CQ, TC,ĐV ",
  },
  {
    question:
      " 48. tiêu chí về kết quả thực hiện chức trách, nhiệm vụ được giao trong đánh giá xếp loại chất lượng C,CC,VC không giữ chức vụ lãnh đạo quản lý được quy định như thế nào?",
    choices: [
      " xây dựng chương trình, kế hoạch hoạt động hàng năm của cơ quan",
      " kết quả thực hiện nhiệm vụ theo quy định của pháp luật, theo kế hoạch đề ra hoặc theo công việc cụ thể đươc giao, khối lượng, tiến độ, chất lượng thực hiện nhiệm vụ",
      " thái độ phục vụ nhân dân doanh nghiệp đối với những vị trí tiếp xúc trực tiếp hoặc trực tiếp giải quyết công việc của người dân và doanh nghiệp",
